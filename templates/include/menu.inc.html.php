...
<?php if(is_admin()) : ?>
  ...
  <a href="#">Créer Admin<img class="link" src="<?= WEBROOT."img".DIRECTORY_SEPARATOR."liste-active.png"?>"alt=""></a>
  ...
  <a href="#">Créer Questions<img class="link" src="<?= WEBROOT."img".DIRECTORY_SEPARATOR."ajout.png"?>"alt=""></a>
<?php endif ?>
  <?php if(is_joueur()) : ?>
